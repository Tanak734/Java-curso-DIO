...
public class StockServiceimpl implements IStockService {
	...
	private final IProductChangeAvabialityProducer producer;

	public StockServiceimpl(StockRepository repository, IProductService productService, IProductQueryService productQueryService, IProductChangeAvabialityProducer producer) {
	...
	public void release(UUID id) {
		changeStatus(id, StockStatus.AVALIABLE);
	}

	@Override
	public void inactive(UUID id) {
		changeStatus(id, StockStatus.UNAVALIABLE);
	}
